...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    function on_close(varargin)        
        try 
            ...
            [filtdata,powdata] = trainAnalyseBin(EEGdata); %any training classification function can be inserted
            assignin('base','filtdata_trn',filtdata);
            assignin('base','powdata_trn',powdata);
            toc
            disp('Start Model Creation')           
            Mdl = fitcecoc(powdata(:,1:32),powdata(:,33)); % need to change model creation(improve)--declare every 4 row represents one observation
